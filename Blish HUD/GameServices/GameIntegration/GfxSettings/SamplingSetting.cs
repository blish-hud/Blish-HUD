namespace Blish_HUD.GameIntegration.GfxSettings {
    public readonly struct SamplingSetting {
        ...
        public static implicit operator string(SamplingSetting samplingSetting) {
            return samplingSetting.Value;
        }

        public static implicit operator SamplingSetting(string value) {
            return new SamplingSetting(value);
        }
