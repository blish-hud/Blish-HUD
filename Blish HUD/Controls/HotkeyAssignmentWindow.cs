...
namespace Blish_HUD.Controls {
    public class HotkeyAssignmentWindow : Container {
        ...
        public HotkeyAssignmentWindow(KeyBinding keyBinding) {
        ...
        //    //_bindingDefinition.Keys.Clear();
        //    //_bindingDefinition.Keys.AddRange(Input.KeysDown);
        ...
        private void BuildChildElements() {
            ...
            //    Text           = string.Format(Strings.GameServices.InputService.Hotkey_AssignInputsTo, _keyBindingDefinition.Name),
        ...
        public override void PaintBeforeChildren(SpriteBatch spriteBatch, Rectangle bounds) {
            ...
            //string hotkeyRep = string.Join(" + ", _bindingDefinition.Keys);
