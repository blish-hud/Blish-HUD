...
namespace Blish_HUD.Controls {
    ...
    public class DetailsButton : FlowPanel {
        ...
        public int CurrentFill {
            ...
            set {
                if (SetProperty(ref _currentFill, Math.Min(value, _maxFill))) {
                    ...
                    _animFill = Animation.Tweener.Tween(this, new {DisplayedFill = _currentFill}, 0.65f).Ease(Ease.QuintIn);
                }
            }
        }
        ...
        public DetailsHighlightType HighlightType {
            get => _highlightType;
            set {
                if (SetProperty(ref _highlightType, value) && this.EffectBehind != null) this.EffectBehind.Enabled = _highlightType == DetailsHighlightType.ScrollingHighlight;
            }
        }
        ...
        public override void RecalculateLayout() {
            ...
            if (this.IconSize == DetailsIconSize.Small) {
                ...
                if (!this.ShowVignette) bottomRegionLeft += 10;
            }
        ...
        public override void PaintBeforeChildren(SpriteBatch spriteBatch, Rectangle bounds) {
            ...
            int iconOffset = this.IconSize == DetailsIconSize.Large ? 0 :
                             !_showVignette                         ? 10 : 0;
            ...
            if (_maxFill > 0 && _showVignette) {
                ...
                if (_currentFill > 0) {
                    ...
                    if (fillPercent < 0.99) spriteBatch.DrawOnCtrl(this, _textureFillCrest, new Rectangle(0, iconSize - (int) fillSpace, iconSize, iconSize));
                }

                if (_showFillFraction)
                    spriteBatch.DrawStringOnCtrl(
                                                 this, $"{_currentFill}/{_maxFill}", Content.DefaultFont14, new Rectangle(0, 0, iconSize, (int) (iconSize * 0.99f)), Color.White,
                                                 true, true, 1, HorizontalAlignment.Center, VerticalAlignment.Bottom
                                                );
            } else if (_icon != null) {
            ...
            if (!_showFillFraction || !(_maxFill > 0 && _showVignette))
                spriteBatch.DrawStringOnCtrl(
                                             this, _iconDetails, Content.DefaultFont14, new Rectangle(0, 0, iconSize, (int) (iconSize * 0.99f)), Color.White,
                                             true, true, 1, HorizontalAlignment.Center, VerticalAlignment.Bottom
                                            );
            ...
            if (_showToggleButton && _children.Any(c => c.Visible)) {
                ...
                var cornerStart = new Point(
                                            lastControl.Left - 4 + this.ContentRegion.X,
                                            _size.Y              - _bottomSectionHeight
                                           );
            ...
            // Draw text
            spriteBatch.DrawStringOnCtrl(
                                         this, _text, Content.DefaultFont14, new Rectangle(iconSize + 20, 0, _size.X - iconSize - 35, this.Height - _bottomSectionHeight), Color.White,
                                         true, true
                                        );
        }
