...
namespace Blish_HUD {
    ...
    public static class PointExtensions {
        ...
        public static System.Drawing.Point ToSystemDrawingPoint(this Microsoft.Xna.Framework.Point point) => new System.Drawing.Point(point.X, point.Y);
        ...
        public static Rectangle InBounds(this Point point, Rectangle bounds) => new Rectangle(bounds.Location, point);
        ...
        public static System.Drawing.Size ToSystemDrawingSize(this Microsoft.Xna.Framework.Point point) => new System.Drawing.Size(point.X, point.Y);
        ...
        public static Microsoft.Xna.Framework.Point ToXnaPoint(this System.Drawing.Point point) => new Microsoft.Xna.Framework.Point(point.X, point.Y);
        ...
        /// <param name="enlarge">A value indicating whether to allow scale ratios above 1.</param>
        /// <returns>A new <see cref="Point"/> with the same aspect ratio as <paramref name="src"/>, scaled to <paramref name="maxWidth"/>, <paramref name="maxHeight"/></returns>
        public static Point ResizeKeepAspect(this Point src, int maxWidth, int maxHeight, bool enlarge) => ResizeKeepAspect(src, maxWidth, maxHeight, ScaleMode.Fit, enlarge);
        ...
        /// <param name="scaleMode">The scaling mode to use when calculating the ratio.</param>
        /// <returns>A new <see cref="Point"/> with the same aspect ratio as <paramref name="src"/>, scaled to <paramref name="maxWidth"/>, <paramref name="maxHeight"/></returns>
        public static Point ResizeKeepAspect(this Point src, int maxWidth, int maxHeight, ScaleMode scaleMode) => ResizeKeepAspect(src, maxWidth, maxHeight, scaleMode, false);
        ...
        /// <param name="maxHeight">The maximum Y bound to scale within.</param>
        /// <returns>A new <see cref="Point"/> with the same aspect ratio as <paramref name="src"/>, scaled to <paramref name="maxWidth"/>, <paramref name="maxHeight"/></returns>
        public static Point ResizeKeepAspect(this Point src, int maxWidth, int maxHeight) => ResizeKeepAspect(src, maxWidth, maxHeight, ScaleMode.Fit, false);
        ...
        public static Point ResizeKeepAspect(this Point src, Point max, ScaleMode scaleMode, bool enlarge) => ResizeKeepAspect(src, max.X, max.Y, scaleMode, enlarge);
        ...
        /// <param name="enlarge">A value indicating whether to allow scale ratios above 1.</param>
        /// <returns>A new <see cref="Point"/> with the same aspect ratio as <paramref name="src"/>, scaled to <paramref name="max"/></returns>
        public static Point ResizeKeepAspect(this Point src, Point max, bool enlarge) => ResizeKeepAspect(src, max.X, max.Y, ScaleMode.Fit, enlarge);
        ...
        /// <param name="scaleMode">The scaling mode to use when calculating the ratio.</param>
        /// <returns>A new <see cref="Point"/> with the same aspect ratio as <paramref name="src"/>, scaled to <paramref name="max"/></returns>
        public static Point ResizeKeepAspect(this Point src, Point max, ScaleMode scaleMode) => ResizeKeepAspect(src, max.X, max.Y, scaleMode, false);
        ...
        /// <param name="max">The maximum bounds to scale within.</param>
        /// <returns>A new <see cref="Point"/> with the same aspect ratio as <paramref name="src"/>, scaled to <paramref name="max"/></returns>
        public static Point ResizeKeepAspect(this Point src, Point max) => ResizeKeepAspect(src, max.X, max.Y, ScaleMode.Fit, false);
        ...
        /// <param name="scaleMode">The scaling mode to use when calculating the ratio.</param>
        /// <returns>A scale value for scaling <paramref name="src"/> with a locked aspect ratio to <paramref name="maxHeight"/>, <paramref name="maxWidth"/></returns>
        public static float GetAspectRatioScale(this Point src, int maxWidth, int maxHeight, ScaleMode scaleMode) => GetAspectRatioScale(src, maxWidth, maxHeight, scaleMode, false);
        ...
        /// <param name="maxHeight">The maximum Y bound to scale within.</param>
        /// <returns>A scale value for scaling <paramref name="src"/> with a locked aspect ratio to <paramref name="maxHeight"/>, <paramref name="maxWidth"/></returns>
        public static float GetAspectRatioScale(this Point src, int maxWidth, int maxHeight) => GetAspectRatioScale(src, maxWidth, maxHeight, ScaleMode.Fit, false);
        ...
        /// <param name="enlarge">A value indicating whether to allow scale ratios above 1.</param>
        /// <returns></returns>
        public static float GetAspectRatioScale(this Point src, Point max, ScaleMode scaleMode, bool enlarge) => GetAspectRatioScale(src, max.X, max.Y, scaleMode, enlarge);
        ...
        public static float GetAspectRatioScale(this Point src, Point max, ScaleMode scaleMode) => GetAspectRatioScale(src, max.X, max.Y, scaleMode, false);
        ...
        /// <param name="max">The maximum bounds to scale within.</param>
        /// <returns>A scale value for scaling <paramref name="src"/> with a locked aspect ratio to <paramref name="max"/></returns>
        public static float GetAspectRatioScale(this Point src, Point max) => GetAspectRatioScale(src, max.X, max.Y, ScaleMode.Fit, false);
    }
}
